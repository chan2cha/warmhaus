...
import AppointmentPanel from "@/app/components/admin/AppointmentPanel";
                    ...
                    <Card variant="outlined" sx={{ borderRadius: 3, height: "100%" }}>
                        <CardContent>
                            ...
                            <Stack direction="row" justifyContent="space-between" alignItems="flex-start" spacing={1}>
                                ...
                                {/* 카드 안에서도 전화 아이콘(상단 헤더에도 있지만, 카드에서 접근성이 더 좋아서 유지 추천) */}
                                <Tooltip title="전화">
                  <span>
                    <IconButton
                        aria-label="전화"
                    ...
                    >
                      <PhoneInTalkIcon />
                            ...
                            <Stack spacing={1}>
                                ...
                                <InfoRow label="면적" value={lead.area_pyeong || "-"} />
                                <InfoRow label="예산" value={lead.budget_raw || "-"} />
                                <InfoRow label="시작/입주" value={`${lead.start_date || "-"} / ${lead.move_in_date || "-"}`} />
